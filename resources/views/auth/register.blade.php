...
<head>
    ...
    <title>Daftar Akun - POS Office</title>
...
<body>
    <div class="auth-card p-4 bg-white">
        ...
        <div class="text-center mb-4">
            <i class="fa-solid fa-user-plus fa-3x text-primary-color mb-2"></i>
            <h5 class="fw-bold text-dark mb-0">Daftar Akun Baru</h5>
            <small class="text-muted">Hanya untuk Administrator dan Owner.</small>
        </div>
        ...
        <div class="text-center mt-3 small">
            Sudah punya akun?
            <a class="text-primary-color text-decoration-none fw-bold" href="{{ route('login') }}">
                Login di sini
            </a>
        </div>
